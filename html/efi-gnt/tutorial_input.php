...
<a href="<?php echo global_settings::get_est_url(); ?>/tutorial.php">EFI-EST tutorial</a>.</li>
...
<center><a href='tutorial_gnn_manipulation.php'><button class="light">Continue Tutorial</button></a></center>
