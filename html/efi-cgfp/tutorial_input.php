...
include("tutorial/tutorial_nav.inc.php");

//include("tutorial/intro.inc.php");
...
?>
<center><a href="tutorial_quantify.php"><button class="light">Continue Tutorial</button></a></center>
<?php
