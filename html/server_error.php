...
<div style="font: 2em bold">Invalid Page!</div>
<div style="font-size: 1.5em; margin-top: 20px;">There was a problem with the page you requested. <?php echo $message; ?></div>
<div style="font-size: 1.2em; margin-top: 20px;"><img src="/images/error505.jpg" alt="Picture of scientist looking into an instrument."></div>
