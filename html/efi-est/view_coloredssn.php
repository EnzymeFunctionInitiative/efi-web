...
if ($job_type === "COLORSSN" || $job_type === "CLUSTER") {
    if (!isset($cluster_has_results)) {
        ...
        echo 'The input SSN did not include any UniProt IDs for the nodes.  The SSN was likely generated by the EFI-EST FASTA option from FASTA files without UniProt IDs in the headers and therefore no metadata can be retrieved.';
