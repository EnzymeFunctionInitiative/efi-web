...
class file_types {
    ...
    private static $types = array(
        ...
        self::FT_fasta_dom_ur90 => array("suffix" => "FASTA_UniRef90_Domain", "ext" => "zip"),
        self::FT_fasta_dom_ur50 => array("suffix" => "FASTA_UniRef50_Domain", "ext" => "zip"),
        ...
        self::FT_sbq_protein_abundance_norm_median => array("suffix" => "protein_abundance_normalized", "ext" => "txt"),
        self::FT_sbq_cluster_abundance_norm_median => array("suffix" => "cluster_abundance_normalized", "ext" => "txt"),
        self::FT_sbq_protein_abundance_genome_norm_median => array("suffix" => "protein_abundance_genome_normalized", "ext" => "txt"),
        self::FT_sbq_cluster_abundance_genome_norm_median => array("suffix" => "cluster_abundance_genome_normalized", "ext" => "txt"),
        ...
        self::FT_sbq_protein_abundance_norm_mean => array("suffix" => "protein_abundance_normalized_mean", "ext" => "txt"),
        self::FT_sbq_cluster_abundance_norm_mean => array("suffix" => "cluster_abundance_normalized_mean", "ext" => "txt"),
        self::FT_sbq_protein_abundance_genome_norm_mean => array("suffix" => "protein_abundance_genome_normalized_mean", "ext" => "txt"),
        self::FT_sbq_cluster_abundance_genome_norm_mean => array("suffix" => "cluster_abundance_genome_normalized_mean", "ext" => "txt"),
