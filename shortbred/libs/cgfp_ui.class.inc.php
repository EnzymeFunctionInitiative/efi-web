...
require_once(__DIR__ . "/cgfp_settings.class.inc.php");
...
HTML;
    ...
    public static function process_load_rows($db, $id_rows, $identify_table = "", $quantify_table = "", $cgfp_db = "") {
        ...
        $default_id_search = strtolower(cgfp_settings::get_default_identify_search());
        $default_quantify_search = strtolower(cgfp_settings::get_default_quantify_search());
